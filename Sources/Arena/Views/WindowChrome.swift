...
enum ArenaPalette {
    ...
    static let primaryLabel = surface(light: 0xFFFFFF, dark: 0x000000)
    static let secondary = surface(light: 0x686868, dark: 0xB0B0B0)
    static let selection = surface(light: 0x006BDF, dark: 0x075CB8)
    static let navigationSelection = surface(light: 0xDEDEDE, dark: 0x414141)
    static let tabSelected = surface(light: 0xFFFFFF, dark: 0x5C5C5C)
    static let dashboardCard = surface(light: 0xFFFFFF, dark: 0x292929)
    static let dashboardBorder = surface(light: 0xD8D8D8, dark: 0x444444)
    static let dashboardAccent = surface(light: 0x006BDF, dark: 0x72B4FF)
    ...
    static let pendingProposal = surface(light: 0x8A5700, dark: 0xEDC27A)
    static let pendingProposalFill = surface(light: 0xFFF1D6, dark: 0x3D321F)
    static let pendingProposalBorder = surface(light: 0xE8C887, dark: 0x745C30)
