...
1. Download the latest `Arena-<version>.dmg` from [GitHub Releases](https://github.com/Playground-Labs/arena/releases/latest).
2. Open the disk image and drag **Arena** onto the **Applications** folder.
